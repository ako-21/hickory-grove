...
import PharmacyData from './../../../data/data_pharmacy.json'
...
class Pharmacy extends React.Component {
  ...
  render () {
    return (
      <GoogleMap defaultZoom={12.5} defaultCenter={{ lat: 34.08425, lng: -84.62300 }}>
        <Marker
        ...
        {PharmacyData.results.map((store, index) => {
